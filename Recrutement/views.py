...
def preselection(request):
    ...
    return render(request, "recrutement/preselection/preselection.html", {"fiches":FichePoste.objects.filter(statu="nonpublier")})

def selection(request):

    return render(request, "recrutement/selection/selection.html", {"fiches":FichePoste.objects.filter(statu="nonpublier")})
